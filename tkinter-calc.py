...
for i in buttons:
    ...
    tk.Button(calc, text=i, width=7, height=7, relief=button_style, command=action,bg='grey', font="lucida 10 bold") \
...
display = tk.Entry(calc, width=40, bg="white", font="lucida 20 bold")
